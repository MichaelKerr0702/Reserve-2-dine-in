        ...
        <div className="row justify-content-center">
          <div className="col-10" id="about-section">
            <p>
              ...
              of the top selling multimedia platforms for reserving
              reservations. From all you can eat, to opening hours from 5 am to
              3 am, Reserve To Dine™ has one of the diverse menus ever seen.
              <p>
